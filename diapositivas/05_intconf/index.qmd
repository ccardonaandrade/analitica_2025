...
result_95 <- t.test(sample$lifeExp , conf.level = 0.95)
result_90 <- t.test(sample$lifeExp , conf.level = 0.90)
result_99 <- t.test(sample$lifeExp, conf.level = 0.99)
...
## 95% IC para 100 muestras {.medium}
...
## 90% IC para 100 muestras {.medium}
