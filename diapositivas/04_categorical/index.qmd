...
2. [Visualizando una variable categórica](#1category)

3. [Visualizando dos variables categóricas](#2categories)
...
# Visualizando una variable categórica {#1category}
...
Un gráfico de barras en el que se muestran proporciones en lugar de frecuencias se llama gráfico de barras de [frecuencia relativa]{.hl .hl-blue}.
:::
...
::: {.absolute top="5%" right="25%" width="400px" .textbox .fragment .fade-up style="font-size:1.7rem;padding:0.5rem 1rem;" .altlist}
...
# Visualizando dos variables categóricas {#2categories}
...
4. Si A y B son eventos [alternativos]{.marker-hl} (no se superponen), entonces $P(A$ $o$ $B)=P(A)+P(B)$
...
6. Si A y B son [independientes]{.marker-hl}, entonces $P(A\, y\, B)=P(A) \cdot P(B)$
...
::: {.absolute top="40%" left="-20%" width="360px" .textbox .fragment .fade-up style="font-size:1.7rem;padding:0.5rem 1rem;" .altlist}
...
## Maneras de detectar *valores atípicos* (Outliers) {.medium}
...
![](img/outliers.png){height="350" fig-align="center"}
...
<center>
[Es importante analizar la causa de los valores atípicos antes de eliminarlos, ya que pueden contener información valiosa.]{.hl .hl-dred}
<center>


## ¿De dónde vienen los *valores atípicos*? {.medium}
...
## Calculando probabilidades para la Distribución Normal {.medium}
...
::: {.absolute top="40%" left="-10%" width="415px" .textbox .fragment .fade-up style="font-size:1.7rem;padding:0.5rem 1rem;" .altlist}
El procedimiento es más claro si grafican el área que van a calcular
:::
