...
3. R es muy flexible y potente, adaptable a casi cualquier tarea, como limpieza de datos, análisis de datos espaciales, machine learning, web scraping, etc
...
## Tipos de Variables en R {.medium}
...
- Las funciones usan [argumentos]{.marker-hl} para funcionar. Pueden ser datos (`my_numbers`) o instrucciones (`title = "Life Expectancy"`)  
...
Es mejor simplemente iniciar una nueva sesión de R.


## Eliminando objetos {.medium}


También habrán notado que R Studio tiene botones prácticos para limpiar el entorno de trabajo y eliminar gráficos individuales. Solo busca estos íconos en los paneles correspondientes:


![](img/broom.png){fig-align="center" width=200 height=80}

## No puedo cubrir todo! {.medium}

- Estas clases son un punto de partida para ayudarlos a aprender

- Desarrollen habilidades y confianza para seguir aprendiendo por su cuenta

- 📚 Deberían leer *ya* 📚

- [R for Data Science](https://r4ds.hadley.nz/intro){target="_blank"} Intro y Caps. 1-3

- [Intro to R for Finance](https://www.datacamp.com/courses/introduction-to-r-for-finance){target="_blank"}
