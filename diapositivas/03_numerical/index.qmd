...
1. [Fundamentos sobre los datos](#data)

2. [El Histograma](#histograma)

3. [Medidas de tendencia central](#central)

4. [Diagrama de caja](#boxplot)

5. [Medidas de dispersión](#dispersion)

6. [Análisis bivariado](#bivariado)
...
2. Intenten el punto anterior con distinto número de *bins*.
...
4. Intenten gráficar el histograma nuevamente y elijan el número de *bins* que para ustedes provea más información.
...
# Medidas de dispersión {#disperson}
