...
La base de datos contiene información detallada sobre las características sensoriales del café, como aroma, sabor, acidez, cuerpo y balance, así como la calificación general (total_cup_points). También incluye variables como el país de origen y el nivel de humedad del grano.
...
`aftertaste`: Calificación otorgada al retrogusto del café.
